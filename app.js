...
function renderVocabPreview(){
  ...
  $('#vocabularyContent').innerHTML=`<div class="vocab-section-title"><b>核心掌握词</b><span>会读 · 知意 · 会写</span></div><div class="vocab-preview-grid">${core.map(previewCard).join('')}</div><div class="vocab-section-title"><b>阅读认识词</b><small>听懂、认得，不要求默写</small></div><div class="vocab-preview-grid">${recognition.map(previewCard).join('')}</div><div class="vocab-start"><p>一次练习约5分钟。先听音，再结合原句辨义，最后补全拼写。</p><button class="primary-button" data-vocab-action="start">开始三步练习 <span>→</span></button></div><div class="review-schedule"><span>今天 · 初学</span><span>第1天 · 看义拼写</span><span>第3天 · 听写</span><span>第7天 · 混合复习</span></div>`;
}
