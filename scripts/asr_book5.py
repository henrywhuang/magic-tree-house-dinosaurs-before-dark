#!/usr/bin/env python3
"""Transcribe Book 5 chapter audio to word-level timestamps."""
import json
...
for chapter in range(1, 11):
    source = ROOT / 'assets' / 'audio' / f'book-05-chapter-{chapter:02d}.mp3'
    target = OUT / f'book5-ch{chapter:02d}.json'
    segments, info = model.transcribe(
        ...
        initial_prompt="A chapter from Magic Tree House: Night of the Ninjas, American English narration.",
    )
    words = [
