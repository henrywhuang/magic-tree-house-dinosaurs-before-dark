#!/usr/bin/env python3
"""Generate a missing Book 9 chapter narration with local Qwen3-TTS."""
import argparse
import json
...
from rebuild_book9 import SOURCE, chapter_text
...
def main():
    ...
    parser.add_argument('--chapter', type=int, choices=range(1, 11), required=True)
    ...
    output = ROOT / 'assets' / 'audio' / f'book-09-chapter-{args.chapter:02d}.mp3'
